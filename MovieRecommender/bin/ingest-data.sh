...
status=`curl -qSfsw "%{http_code}\\n" -H "Authorization: Bearer $auth_token" -X POST --data-binary @"$bin"/../resources/movies.dat http://$gateway:10000/v2/apps/MovieRecommender/services/MovieDictionaryService/methods/storemovies`
